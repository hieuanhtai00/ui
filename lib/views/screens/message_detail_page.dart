            ...
            Expanded(
              child: Container(
                child: ListView(
                  ...
                  children: [
                    MyBubbleChatWidget(
                      chat: 'Cảm ơn bạn, tôi xem đủ rồi',
                      time: '10:48',
                    ),
                    SenderBubbleChatWidget(
                      chat: 'Cảm ơn bạn, bạn có xem thêm một số mẫu nữa không',
                      time: '10:48',
                    ),
                    MyBubbleChatWidget(
                      chat: 'Ồ, mẫu mã rất đẹp, giá cũng rất phải chăng',
                      time: '10:48',
                    ),
                    SenderBubbleChatWidget(
                      chat:
                          'Vâng ạ, mẫu mã của bên shop hãng chúng tôi rất đẹp, bạn có thể xem trong trang chính',
                      time: '10:48',
                    ),
                    MyBubbleChatWidget(
                      chat:
                          'Xin chào, tôi muốn được tư vấn một số mặt hàng của shop bạn',
                      time: '10:48',
                    ),
                    SenderBubbleChatWidget(
                      chat: 'Xin chào, tôi có thể giúp gì được cho bạn',
                      time: '10:48',
                    ),
                  ],
                ),
